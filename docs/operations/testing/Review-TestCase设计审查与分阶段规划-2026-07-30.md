...
> **历史快照**：本文保留 2026-07-30 审查基线与当时差距，不是当前可执行安全合同。当前 pytest/offline entrypoint、FT7、U1/G8/FT5 和验收证据以 [`tests/CLAUDE.md`](../../../tests/CLAUDE.md) 与 [`真实数据验证Runbook.md`](./真实数据验证Runbook.md) 为准。
