...
> 详见 [M12 完成报告](../milestones/M12_COMPLETION_REPORT.md)。
>
> **说明（2026-03）**：本文件在历史减重后仅保留 Phase 2 总览。原 Phase 2A / 2B / M14 / M15 的子 Prompt 已移除，不再单独保存。
...
### 当前仍可对应的核心文档
- [`docs/history/prompts/PHASE1_DEV_PROMPT.md`](./PHASE1_DEV_PROMPT.md) - Phase 1 历史总览
- [`docs/overview/personal-knowledge-vault-prd.md`](../../overview/personal-knowledge-vault-prd.md) - 核心需求文档
- [`docs/overview/架构设计.md`](../../overview/架构设计.md) - 工作流驱动架构
- [`docs/overview/技术选型.md`](../../overview/技术选型.md) - 技术栈选型

### 归并说明
- Phase 2A / Phase 2B / M14 / M15 子 Prompt 已在 2026-03 历史减重中移除
- 如需看当前模块文档，请转到 `docs/modules/`、`docs/specs/` 与 `docs/operations/`

### 当前模块文档
- [`docs/modules/mcp/MCP_SERVICE_DESIGN.md`](../../modules/mcp/MCP_SERVICE_DESIGN.md) - MCP 服务技术设计
- [`docs/modules/gui/GUI_FRAMEWORK_ANALYSIS.md`](../../modules/gui/GUI_FRAMEWORK_ANALYSIS.md) - GUI 框架选型分析

### 接口规范（复用现有模块）
- [`docs/specs/models/Entry数据模型规范.md`](../../specs/models/Entry数据模型规范.md)
- [`docs/specs/interfaces/Processors接口规范.md`](../../specs/interfaces/Processors接口规范.md)
- [`docs/specs/interfaces/Storage接口规范.md`](../../specs/interfaces/Storage接口规范.md)
- [`docs/specs/interfaces/Retrieval检索引擎规范.md`](../../specs/interfaces/Retrieval检索引擎规范.md)
- [`docs/specs/interfaces/WorkflowEngine接口规范.md`](../../specs/interfaces/WorkflowEngine接口规范.md)
...
|-----------|------|------|------|---------|------------|
| **M8** | v0.7.0-alpha | ✅ **已完成** | MCP 只读服务 | 5 个只读 Tool + 4 个 Resource + 单元/集成测试 | 已归并 |
| **M9** | v0.7.0 | ✅ **已完成** | MCP 写入 + Prompts | 3 个写入 Tool + 3 个 Prompt + 安全加固 + 三层测试 203 个 | 已归并 |
| **M10** | v0.8.0-alpha | ✅ **已完成** | GUI 基础框架 | 主窗口 + 知识浏览 + 搜索 + 130 测试 | 已归并 |
| **M11** | v0.8.0-beta | ✅ **已完成** | GUI 归档 + 设置 + 额外加固 | 归档界面 + 设置界面 + 统计面板 + 知乎登录墙 + 删除功能 + Embedding 可配置 | 已归并 |
| **M12** | v0.8.0 | ✅ **已完成** | AI 对话交互 | 聊天界面 + 对话服务 + 对话存储 + 知识引用 + Token 控制 + 218 tests | 已归并 |
| **M13** | v0.8.1 | ⏭️ **被跳过** | ~~GUI 打包与集成测试~~ | **决策**: 打包是工程细节，应在工作流完整性验证后进行 | 已归并 |
| **M14** | v0.9.0 | 🔲 **待开始** | **用户审核系统** ⭐ | CLI 审核流程 + 历史追踪 + 所有工作流集成 | [`review-system-prd.md`](../../modules/review/review-system-prd.md) |
...
**文档与交付**:
- [M14 Product Requirements Document](../../modules/review/review-system-prd.md) — 完整需求文档
- M14 Development Prompt 已在 2026-03 历史减重中移除
